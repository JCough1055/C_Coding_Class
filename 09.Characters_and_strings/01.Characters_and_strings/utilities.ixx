...
export void domain_password_demo(){

    //Domain_Password::check_valid_Domain();
    Domain_Password::check_valid_password();
}

export void string_views_demo(){
   //string_views::string_views_the_problem() ;
